  ...
  const fetchAttendance = async () => {
    try {
      ...
      if (todayRecord) {
        ...
        setTaskTitle(todayRecord.taskTitle || '')
        setTaskDescription(todayRecord.taskDescription || '')
        setWorkCompleted(todayRecord.workCompleted || '')
        setScreenshot(todayRecord.screenshotUrl || '')
      }
