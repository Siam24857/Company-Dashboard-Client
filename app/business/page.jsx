  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted mt-1">Here's what's happening with your business management tasks today.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          { label: 'Pending Tasks', value: stats.pendingTasks, icon: FolderOpen, color: 'text-orange' },
