      ...
      <div className="card">
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted">{user?.profession || 'Business Manager'}</p>
      ...
      <div className="card">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input type="text" value={formData.skills?.join(', ') || ''} onChange={(e) => setFormData({ ...formData, skills: e.target.value.split(',').map(s => s.trim()).filter(Boolean) })} disabled={!editing} className="input w-full" placeholder="React, Node.js, PostgreSQL" />
          </div>
          <div>
      ...
      <div className="card">
        ...
        {user?.resumeUrl && (
          <div className="flex items-center gap-4">
            <a href={user.resumeUrl} target="_blank" rel="noopener noreferrer" className="btn-secondary flex items-center gap-2">
